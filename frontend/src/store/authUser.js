...
export const useAuthStore = create((set) => ({
    ...
    logout: async () => {
        ...
        try {
            await axios.post("https://netflix-clone-api-xi.vercel.app/api/v1/auth/logout", {}, {withCredentials: true});
    ...
    authCheck: async () => {
        ...
        try{
            const response = await axios.get("https://netflix-clone-api-xi.vercel.app/api/v1/auth/authCheck", {withCredentials: true});
