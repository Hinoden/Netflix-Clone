...
const SearchHistoryPage = () => {
    ...
    useEffect(() => {
        const getSearchHistory = async () => {
            try {
                const res = await axios.get(`https://netflix-clone-lemon-theta.vercel.app/search/history`);
    ...
    const handleDelete = async (entry) => {
        try{
            await axios.delete(`https://netflix-clone-lemon-theta.vercel.app/search/history/${entry.id}`);
