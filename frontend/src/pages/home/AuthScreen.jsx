    ...
    return (
        <div className='hero-bg relative'>
            ...
            <header className='max-w-6xl mx-auto flex items-center justify-between p-4 pb-10'>
                ...
                <Link to={"https://netflix-clone-actl4ukid-kristinas-projects-8c5c6242.vercel.app/login"} className='text-white bg-red-600 py-1 px-2 rounded'>
                    Sign In
                </Link>
            </header>
                            ...
                            <div className='flex items-center gap-2 absolute bottom-5 left-1/2 -translate-x-1/2 bg-black w-3/4 lg:w-1/2 h-24 border border-slate-500 rounded-md px-2'>
                                ...
                                <div className='flex justify-between items-center w-full'>
                                    <div className='flex flex-col gap-0'>
                                        <span className='text-md lg:text font-bold'>Stranger Things</span>
