...
const WatchPage = () => {
    ...
    useEffect(() => {
        const getSimilarContent = async () => {
            try {
                const res = await axios.get(`https://netflix-clone-black-two.vercel.app/api/v1/${contentType}/${id}/similar`);
    ...
    useEffect(() => {
        const getContentDetails = async () => {
            try {
                const res = await axios.get(`https://netflix-clone-black-two.vercel.app/api/v1/${contentType}/${id}/details`);
    ...
    return (
        <div className='bg-black min-h-screen text-white'>
            <div className='mx-auto container px-4 py-8 h-full'>
                ...
                {/* movie details */}
                <div className='flex flex-col md:flex-row items-center jsutify-between gap-20 max-w-6xl mx-auto'>
